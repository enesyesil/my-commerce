  ...
  <div className="min-h-screen bg-yellow-200 flex flex-col justify-between">
    ...
    <main className="p-6">
      ...
      <form className="max-w-md mx-auto bg-yellow-300 border-2 border-black p-6 rounded-lg">
        ...
        <button
          type="button"
          className="w-full bg-green-500 text-white py-2 px-4 rounded shadow-sm font-bold transition-transform transform hover:scale-105"
          onClick={() => {
            // Corrected by wrapping the expression in curly braces
